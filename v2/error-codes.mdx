...
| `402` Payment Required | Insufficient credits. | Your account has run out of credits, or otherwise requires payment before the request can be completed. Check your balance with the [account usage endpoint](/v2/api-reference/account/usage-stats). |
...
- **Check your credit balance on `402`.** Use the [account usage endpoint](/v2/api-reference/account/usage-stats) to confirm you have credits remaining before retrying.
