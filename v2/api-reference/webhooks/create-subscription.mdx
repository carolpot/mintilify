...
<ParamField body="defaults" type="object" required>
  ...
  <Expandable title="properties">
    ...
    <ParamField body="defaults.signalTypes" type="string[]">
      Default signal type keys for all subscriptions in the request. Available signals depend on entity type - see the [Signal Options](/v2/api-reference/signals/get-signal-options) reference for the full list. Can be overridden per subscription item.
    </ParamField>
  </Expandable>
</ParamField>
...
- All delivery attempts are recorded in [audit logs](/v2/api-reference/webhooks/get-audit-logs).
