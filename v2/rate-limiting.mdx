...
If your integration encounters unexpected errors beyond rate limiting, review the full list of [error codes](/v2/error-codes) to understand what each HTTP status code means and how to respond.
