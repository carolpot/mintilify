...
<Note>
Website Visitor Tracking requires the Lusha tracking pixel to be set up on your site. See [Website Visitors](#) for setup details.
</Note>
...
Signals are powered by Lusha's verified, structured data. They're refreshed on the cadences listed above and validated through multiple sources.
