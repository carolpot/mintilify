...
<Steps>
  <Step title="Open the contact">
    Open the contact in **Lusha Search** or the **Lusha Extension**.
  </Step>
  <Step title="Click the Report icon">
    Click the **thumbs down** or **Report** icon next to the incorrect detail.
  </Step>
  <Step title="Select a reason">
    Select the reason (e.g. wrong number, bounced email, no longer at company).
  </Step>
