...
<Steps>
  <Step title="Open the sequence">
    Go to **Engage** → **Sequences** and open the sequence you want to edit.
  </Step>
  <Step title="Hover over the step to move">
    Hover over the step you want to move. A drag handle appears on the left side of the step.
  </Step>
  <Step title="Drag the step">
    Click and hold the drag handle, then drag the step to its new position.
  </Step>
