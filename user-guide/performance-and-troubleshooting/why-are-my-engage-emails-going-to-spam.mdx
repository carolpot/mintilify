...
<Note>
DNS changes can take up to 48 hours to propagate. Allow time before testing again.
</Note>
...
For provider-specific daily limits, see the [Engage sending limits by email provider](/user-guide/performance-and-troubleshooting/engage-sending-limits-by-email-provider) & [Email limits best practices](/user-guide/performance-and-troubleshooting/email-limits-best-practices) articles.
...
<Warning>
If you believe your domain has been blacklisted, contact Lusha Support immediately - continued sending from a blacklisted domain makes recovery harder.
</Warning>
