...
<Note>
These are provider-imposed limits, not Lusha limits. Lusha enforces its own sending caps to protect your deliverability - see [Email limits best practices](/user-guide/performance-and-troubleshooting/email-limits-best-practices) for Lusha's recommended daily sending volumes.
</Note>
...
<Warning>
Consistently exceeding limits can result in your account being flagged or temporarily suspended by your email provider.
</Warning>
...
<Steps>
  <Step title="Open Engage">
    Go to **[Engage](https://dashboard.lusha.com/engage).**
  </Step>
  <Step title="Check the Emails Sent metric">
    View the **Emails Sent** metric for today to see how many have been sent from your connected account at the top toolbar.
  </Step>
  <Step title="Adjust the sequence schedule if needed">
