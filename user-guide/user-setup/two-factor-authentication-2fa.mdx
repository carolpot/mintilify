...
Verification is required once every 90 days and is tied to the specific browser and device you use. If you switch browsers or devices, you will need to verify again. Once verified, the session will remain active for 90 days on that browser or device.

To stay logged in for 90 days, adjust your Inactivity Timeout settings:

<Steps>
  <Step title="Open Settings">
    On your Lusha Dashboard, click the **Settings** icon in the left navigation.
  </Step>
  <Step title="Open the Account Settings tab">
    Go to the **Account Settings** tab.
  </Step>
  <Step title="Set the inactivity timeout">
    Set the **Inactivity Timeout** to **90 days**.
  </Step>
</Steps>

<Frame>
  <img src="https://downloads.intercomcdn.eu/i/o/yu27vhse/59908157/d9017acbcb94ee9368d81f998abd/Screenshot%2B2025-08-05%2Bat%2B10_52_13.png?expires=1780056000&signature=7ab7e285e2b09c6a9d17e70a7585f9da6419173d2cb72a27d58d398e95b0ad56&req=1dxmxVD7qTBk2hj99dpg6h70p0lv6C4vixXf6xHRr8F%2Fervw3P7Ig97urag2%0AqNX96R%2FAUkEqdWrlqo7gwGdT%0A" alt="Account Settings page with the Inactivity Timeout field set to 90 days" style={{maxWidth: "100%", height: "auto"}} />
</Frame>

You’ll stay logged in for up to **90 days**, unless:
