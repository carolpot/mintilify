...
<Steps>
  <Step title="Open the chat widget">
    Go to our **[Help Center](https://info.lusha.com/en/)** or your **[Lusha Dashboard](https://dashboard.lusha.com/dashboard)** and press on the purple icon in the lower-right corner of any page.
  </Step>
  <Step title="Send a message">
    Click **Send us a message.**
  </Step>
  <Step title="Chat with support">
