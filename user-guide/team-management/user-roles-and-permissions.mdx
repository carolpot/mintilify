...
<Steps>
  ...
  <Step title="Select the users to update">
    Select the user or users whose role you want to change.
  </Step>
  <Step title="Open the role change dialog">
    Click **Change role**.
  </Step>
