...
When a subscribed entity triggers a signal, Lusha sends a signed JSON payload to your webhook URL. Signals include contact events such as promotions and job changes, as well as company events such as commercial activity news and growth milestones. For the full list of available signal types, see [Contact Signal Types](/api-reference/signals/contact-signal-types) and [Company Signal Types](/api-reference/signals/company-signal-types).
